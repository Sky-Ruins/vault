...
public interface Economy {
    ...
    /**
     * Some economy plugins round off after a certain number of digits. This function returns the number of digits the plugin keeps or -1 if no
     * rounding occurs.
     *
    ...
    /**
     * Returns the name of the currency in plural form. If the economy being used does not support currency names then an empty string will be
     * returned.
     *
    ...
    /**
     * Returns the name of the currency in singular form. If the economy being used does not support currency names then an empty string will be
     * returned.
     *
    ...
    /**
     * Checks if this player has an account on the server yet. This will always return true if the player has joined the server at least once as all
     * major economy plugins auto-generate a player account when the player joins the server.
     *
    ...
    /**
     * Checks if this player has an account on the server yet on the given world. This will always return true if the player has joined the server at
     * least once as all major economy plugins auto-generate a player account when the player joins the server.
     *
    ...
    /**
     * Gets balance of a player on the specified world. IMPLEMENTATION SPECIFIC - if an economy plugin does not support this the global balance will
     * be returned.
     *
     * @param player to check
    ...
    /**
     * Checks if the player account has the amount in a given world - DO NOT USE NEGATIVE AMOUNTS IMPLEMENTATION SPECIFIC - if an economy plugin does
    ...
    /**
     * Withdraw an amount from a player on a given world - DO NOT USE NEGATIVE AMOUNTS IMPLEMENTATION SPECIFIC - if an economy plugin does not support
    ...
    /**
     * Deposit an amount to a player - DO NOT USE NEGATIVE AMOUNTS. IMPLEMENTATION SPECIFIC - if an economy plugin does not support this the global
    ...
    /**
     * Attempts to create a player account for the given player on the specified world. IMPLEMENTATION SPECIFIC - if an economy plugin does not
