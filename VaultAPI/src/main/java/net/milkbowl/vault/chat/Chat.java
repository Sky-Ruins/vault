...
public abstract class Chat {
    ...
    /**
     * Get players prefix from the world they are currently in. May or may not return the global prefix depending on implementation.
     *
    ...
    /**
     * Sets players prefix in the given world. Use NULL for world for setting in the Global scope.
     *
     * @param world World name
     * @param player OfflinePlayer
     * @param prefix Prefix
     ...
     * @param node Permission node
     * @param value Value to set
     * @deprecated As of VaultAPI 1.4 use {{@link #setPlayerInfoDouble(String, OfflinePlayer, String, double)} instead. Set a players informational
     * node (Double) value
     */
    @Deprecated
     ...
     * @param node Permission node
     * @param value Value to set
     * @deprecated As of VaultAPI 1.4 use {{@link #setPlayerInfoBoolean(String, OfflinePlayer, String, boolean)} instead. Set a players informational
     * node (Boolean) value
     */
    @Deprecated
