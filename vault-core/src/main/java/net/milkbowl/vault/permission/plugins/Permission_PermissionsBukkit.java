...
public class Permission_PermissionsBukkit extends Permission {
    ...
    public boolean playerAdd(String world, String player, String permission) {
        ...
        return plugin.getServer()
                .dispatchCommand(Bukkit.getServer().getConsoleSender(), "permissions player setperm " + player + " " + permission + " true");
    }
    ...
    public boolean groupAdd(String world, String group, String permission) {
        ...
        return plugin.getServer()
                .dispatchCommand(Bukkit.getServer().getConsoleSender(), "permissions group setperm " + group + " " + permission + " true");
    }
