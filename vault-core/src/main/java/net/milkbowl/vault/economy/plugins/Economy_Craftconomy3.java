...
public class Economy_Craftconomy3 extends AbstractEconomy {
    ...
    public double getBalance(String playerName, String world) {
        return Common.getInstance().getAccountManager().getAccount(playerName, false)
                .getBalance(world, Common.getInstance().getCurrencyManager().getDefaultCurrency().getName());
    }
    ...
    public EconomyResponse withdrawPlayer(String playerName, String worldName, double amount) {
        ...
        if (account.hasEnough(amount, worldName, Common.getInstance().getCurrencyManager().getDefaultCurrency().getName())) {
            balance =
                    account.withdraw(amount, worldName, Common.getInstance().getCurrencyManager().getDefaultCurrency().getName(), Cause.VAULT, null);
    ...
    public EconomyResponse depositPlayer(String playerName, String worldName, double amount) {
        ...
        double balance =
                account.deposit(amount, worldName, Common.getInstance().getCurrencyManager().getDefaultCurrency().getName(), Cause.VAULT, null);
    ...
    public boolean has(String playerName, String worldName, double amount) {
        return Common.getInstance().getAccountManager().getAccount(playerName, false)
                .hasEnough(amount, worldName, Common.getInstance().getCurrencyManager().getDefaultCurrency().getName());
    }
    ...
    public EconomyResponse bankWithdraw(String name, double amount) {
        ...
        if (!er.transactionSuccess()) {
            ...
            if (Common.getInstance().getAccountManager().exist(name, true)) {
                return new EconomyResponse(0, Common.getInstance().getAccountManager().getAccount(name, true)
                        .withdraw(amount, WorldGroupsManager.DEFAULT_GROUP_NAME,
                                Common.getInstance().getCurrencyManager().getDefaultBankCurrency().getName(), Cause.VAULT, null),
    ...
    public EconomyResponse bankDeposit(String name, double amount) {
        ...
        if (Common.getInstance().getAccountManager().exist(name, true)) {
            return new EconomyResponse(0, Common.getInstance().getAccountManager().getAccount(name, true)
                    .deposit(amount, WorldGroupsManager.DEFAULT_GROUP_NAME,
                            Common.getInstance().getCurrencyManager().getDefaultBankCurrency().getName(), Cause.VAULT, null), ResponseType.SUCCESS,
                    "");
        }
        return new EconomyResponse(0, 0, ResponseType.FAILURE, "That bank does not exist!");
    }
