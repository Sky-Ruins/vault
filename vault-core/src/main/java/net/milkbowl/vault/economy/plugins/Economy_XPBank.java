...
public class Economy_XPBank extends AbstractEconomy {
    ...
    public EconomyResponse isBankOwner(String name, String playerName) {
        ...
        return new EconomyResponse(0, groupBank.getBalance(), ResponseType.FAILURE,
                String.format(api.getMsg("PlayerNotOwner"), account.getName(), groupBank.getName()));
    }
    ...
    public EconomyResponse isBankMember(String name, String playerName) {
        ...
        return new EconomyResponse(0, groupBank.getBalance(), ResponseType.FAILURE,
                String.format(api.getMsg("NotAMemberOf"), groupBank.getName(), account.getName()));
    }
